...
namespace Vanilla.Api.Data;

public sealed class AppDbContext(DbContextOptions<AppDbContext> options, IFieldEncryptionService encryptionService) : DbContext(options)
{
